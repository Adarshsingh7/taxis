...
function Booking({ bookingData, id, onBookingUpload }) {
  ...
  return (
    <div className=" bg-background text-foreground p-4">
      <form autoComplete="off" id="myForm" action="" onSubmit={handleSubmit}>
        <>
          ...
          <Modal open={isDriverModalActive} setOpen={setDriverModalActive}>
            <ListDrivers
              onSet={addDriverToBooking}
              setOpen={setDriverModalActive}
            />
          </Modal>
          <Modal open={isAddVIAOpen} setOpen={setIsAddVIAOpen}>
            <AddAndEditVia onSet={setIsAddVIAOpen} />
          </Modal>
          <Modal open={isQuoteDialogActive} setOpen={setIsQuoteDialogActive}>
            <QuoteDialog onSet={setIsQuoteDialogActive} id={id} quote={quote} />
          </Modal>
          <SimpleSnackbar />
        </>
